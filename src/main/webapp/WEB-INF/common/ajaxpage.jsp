...
<c:if test="${page.pageIndex != 1}">
	<a href="javascript:;" onclick="turnPage(1)">首页</a>
...
<select onchange="changePageSize(this.value);" style="width:100px;opacity:100;border:1px solid #ccc">
...
<option value="25" ${page.pageSize==25?"selected":"" }>每页25条</option>
<option value="30" ${page.pageSize==30?"selected":"" }>每页30条</option>
</select>
